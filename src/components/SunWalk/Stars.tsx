...
const Stars = () => {
    return (
        <div className={cn(s.bg, s.starsBg)}>
            <svg className={s.stars} viewBox="0 0 300 382" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M62 86L62.1697 93.8303L70 94L62.1697 94.1697L62 102L61.8303 94.1697L54 94L61.8303 93.8303L62 86Z"
                    fill="#D9D9D9"/>
                <path d="M171 295L171.13 299.925L175.33 302.5L171 300.15L166.67 302.5L170.87 299.925L171 295Z"
                      fill="#D9D9D9"/>
                <path
                    d="M233.5 171L233.975 179.677L241.727 175.75L234.45 180.5L241.727 185.25L233.975 181.323L233.5 190L233.025 181.323L225.273 185.25L232.55 180.5L225.273 175.75L233.025 179.677L233.5 171Z"
                    fill="#D9D9D9"/>
                <path
                    d="M15 218L15.2939 222.595L19.7553 221.455L15.4755 223.155L17.9389 227.045L15 223.5L12.0611 227.045L14.5245 223.155L10.2447 221.455L14.7061 222.595L15 218Z"
                    fill="#D9D9D9"/>
                ...
                <path d="M150.5 120.5L167.5 162.5L143 181L111 151.5L95 149L53.5 198.5" stroke="white"
                      strokeOpacity="0.02"/>
                ...
                <path
                    ...
                    stroke="white" strokeOpacity="0.02"/>
                ...
                <path d="M268.5 269.5L275.5 257.5L268.5 208.5L286 183L298.5 200.5L294 255" stroke="white"
                      strokeOpacity="0.02"/>
